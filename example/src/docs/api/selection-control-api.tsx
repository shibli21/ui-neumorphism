...
export const selectionControlApi = (
  dark: boolean,
  type: string,
  valueKey = "value"
) => {
...
export const switchApi = (dark: boolean) => {
  return selectionControlApi(dark, "Switch");
};

export const checkboxApi = (dark: boolean) => {
  return selectionControlApi(dark, "Checkbox");
};

export const radioApi = (dark: boolean) => {
  return [...selectionControlApi(dark, "Radio", "checked")];
};

export const radioGroupApi = (dark: boolean) => {
  return [
    ...defaultApiDoc(dark),
    createApiDoc(
      dark,
