...
const disabled = (dark: boolean, type: string) =>
  createApiDoc(
    dark,
    "disabled",
    "Boolean",
...
const rounded = (dark: boolean, type: string) =>
  createApiDoc(
    dark,
    "rounded",
    "Boolean",
...
export const cardApi = (dark: boolean, type = "card") => {
  return [
    ...defaultApiDoc(dark),
    createApiDoc(
      dark,
...
export const cardHeaderApi = (dark: boolean) => {
  return [
    ...defaultApiDoc(dark),
    createApiDoc(
      dark,
...
export const cardContentApi = (dark: boolean) => {
  return [
    ...defaultApiDoc(dark),
...
export const cardMediaApi = (dark: boolean) => {
  return [
    ...defaultApiDoc(dark),
...
export const cardActionApi = (dark: boolean) => {
  return [
    ...defaultApiDoc(dark),
