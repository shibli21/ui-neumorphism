export const importCode = `import React, { Component } from 'react'
...
`;
export const themeUtilCode = `import React, { Component } from 'react'
...
export type ThemeType = 'light-1' | 'light-2' | 'light-3' | 'light-4' | 'dark-1' | 'dark-2' | 'dark-3' | 'dark-4' | 'default';
