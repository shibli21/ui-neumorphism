...
const styleDoc = (dark: boolean, prop: string, type: string) =>
  createApiDoc(dark, prop, "Number", "", `Sets the ${prop} for the ${type}.`);

export const cssDimensionsApi = (dark: boolean, type: string) => {
  return [
...
export const positionApi = (dark: boolean, type: string) => {
