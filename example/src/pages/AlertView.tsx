  ...
  return (
    <Card flat dark={dark}>
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            The <code>type</code> prop provides 4 default alert styles: success,
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            The <code>color</code> prop can be used to specify the color of the
            alert.
          </Subtitle1>
        }
        content={
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            alert. Clicking it calls the <code>onClose</code> callback.
            <br />
            Using the <code>visible</code> prop and onClose callback, you can
            show/hide alert at will.
            <br />
            Use <code>closeIcon</code> to give a custom close icon to the alert.
          </Subtitle1>
        }
        content={
          <Card flat className="mt-6 d-flex flex-column align-center">
            ...
            {visible1 ? null : (
              <Card flat className="mb-6">
                <Button onClick={() => setVisible1(true)}>show</Button>
              </Card>
            )}
            <Alert
              className="mb-6"
