...
import { progressCircularApi } from "../docs/api/progress-api";
import {
  progressCircular,
  progressCircularLabel,
} from "../docs/code/progress-code";
const url =
  ...
  return (
    <Card flat dark={dark}>
      ...
      <Subtitle1 className="mt-3">
        ProgressCircular is used to convey data circularly to users. It also can
        be put into an indeterminate state to portray loading.
      </Subtitle1>
      <DocCard
        url={url}
        className="mt-12"
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            Using the <code>elevated</code> prop, ProgressCircular can be given
            an alternate raised style.
          </Subtitle1>
        }
        content={
          <Card
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            text or provide data as children.
          </Subtitle1>
        }
        content={
          <Card
      ...
      <ApiCard
        dark={dark}
        entity="ProgressCircular"
        data={progressCircularApi(dark)}
      />
    </Card>
  );
};
