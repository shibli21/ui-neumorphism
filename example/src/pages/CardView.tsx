...
const CardView = (props: { dark: true }) => {
  ...
  return (
    <Card flat dark={dark} className="code-block-container">
      ...
      <ApiCard dark={dark} entity="Card" data={cardApi(dark)} />
      <div className="mt-12"></div>
      <ApiCard dark={dark} entity="CardHeader" data={cardHeaderApi(dark)} />
      <div className="mt-12"></div>
      <ApiCard dark={dark} entity="CardMedia" data={cardMediaApi(dark)} />
      <div className="mt-12"></div>
      <ApiCard dark={dark} entity="CardContent" data={cardContentApi(dark)} />
      <div className="mt-12"></div>
      <ApiCard dark={dark} entity="CardAction" data={cardActionApi(dark)} />
    </Card>
  );
};
