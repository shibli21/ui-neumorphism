...
import { parallaxApi } from "../docs/api/parallax-api";
import { simpleParallax } from "../docs/code/parallax-code";

const url =
  "https://github.com/AKAspanion/ui-neumorphism/blob/master/example/src/pages/ParallaxView.jsx";

const ParallaxView = ({ dark }: { dark: boolean }) => {
  return (
    <Card flat dark={dark}>
      <span id="component"></span>
      <H4>
        <a href="#component">Parallax</a>
      </H4>
      <H6>
        The Parallax component creates a 3D effect that makes an image appear to
        scroll slower than the window.
      </H6>
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            name&nbsp;<code>containerId</code>, if found hooks the scroll event
            to it, or else uses the document scroll event.
          </Subtitle1>
        }
        content={
          <Card
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            You can specify a parallax <code>speed</code> multiplier to specify
            how fast image scrolls past.
            <br />
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            <br />
            Keep in mind this can break the parallax if your image is not sized
            properly.
          </Subtitle1>
        }
        content={
      ...
      <ApiCard dark={dark} entity="Parallax" data={parallaxApi(dark)} />
    </Card>
  );
};
