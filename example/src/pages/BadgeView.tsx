...
import { badgeApi } from "../docs/api/badge-api";
import {
  simpleBadge,
  dotBadge,
  borderedBadge,
  ...
  colorBadge,
  customBadge,
} from "../docs/code/badge-code";

const url =
  "https://github.com/AKAspanion/ui-neumorphism/blob/master/example/src/pages/BadgeView.jsx";

const BadgeView = (props: { dark: boolean }) => {
  const { dark } = props;
  return (
    <Card flat dark={dark}>
      <span id="component"></span>
      <H4>
        <a href="#component">Badge</a>
      </H4>
      <H6>Badge generates a small badge to the top-right of its child(ren).</H6>
      <DocCard
        className="mt-12"
        url={url + "#L64-L72"}
      ...
      <ApiCard dark={dark} entity="Badge" data={badgeApi(dark)} />
    </Card>
  );
};
