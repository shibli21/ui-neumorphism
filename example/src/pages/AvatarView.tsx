...
import { avatarApi } from "../docs/api/avatar-api";
import {
  colorAvatar,
  fallBackAvatar,
  iconAvatar,
  ...
  return (
    <Card flat dark={dark}>
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            Avatar by default is circular type. <br /> To use square or rounded
            avatars, use the <code>square</code> and&nbsp;
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            Use <code>size</code> prop to change avatar size. You can also give
            custom size numbers.
          </Subtitle1>
        }
        content={
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            <code>src</code>, the component falls back to an alternative in the
            following order.
            <br />
        ...
        content={
          <Card
            ...
            className="mt-6 d-flex align-center justify-center flex-wrap"
          >
            <Avatar className="ma-3" src="broken.jpg" alt="Ankit Kumar Pandit">
              AK
            </Avatar>
            <Avatar
              className="ma-3"
      ...
      <ApiCard dark={dark} entity="Avatar" data={avatarApi(dark)} />
    </Card>
  );
};
