...
import { fabButtonApi } from "../docs/api/button-api";
import { fabButtons, fabPosButtons } from "../docs/code/button-code";
  ...
  return (
    <Card flat dark={dark}>
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            Use the <code>fixed</code> or <code>absolute</code> prop along with{" "}
            <code>top</code>, <code>left</code>, <code>right</code>, or&nbsp;
      ...
      <ApiCard dark={dark} entity="Fab" data={fabButtonApi(dark)} />
    </Card>
  );
};
