...
import { Card, Chip, Divider, H4, H6, Subtitle1 } from "ui-neumorphism";

import ApiCard from "../containers/ApiCard";
import DocCard from "../containers/DocCard";
import { chipApi } from "../docs/api/chip-api";
  ...
  return (
    <Card flat dark={dark}>
      ...
      <Subtitle1 className="mt-3">
        ...
        or trigger actions. While buttons are expected to appear consistently
        and with familiar calls to action, chips should appear dynamically as a
        group of multiple interactive elements.
      </Subtitle1>
      <DocCard
        url={url}
        content={
      ...
      <ApiCard dark={dark} entity="Chip" data={chipApi(dark)} />
    </Card>
  );
};
