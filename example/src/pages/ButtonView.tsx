...
import { buttonApi } from "../docs/api/button-api";
import {
  allButtons,
  docButtons,
  blockButton,
...
const ButtonView = (props: { dark: boolean }) => {
  const { dark } = props;
  return (
    <Card flat dark={dark}>
      <H4>
      ...
      <DocCard
        ...
        content={
          <Card flat className="pa-8 fill-width">
      ...
      <ApiCard dark={dark} entity="Button" data={buttonApi(dark)} />
    </Card>
  );
};
