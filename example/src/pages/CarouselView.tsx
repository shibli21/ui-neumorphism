...
import {
  ...
  customArrows,
  customCarousel,
} from "../docs/code/carousel-code";
import { carouselApi, carouselItemApi } from "../docs/api/carousel-api";
  ...
  return (
    <Card flat dark={dark}>
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            transitions to the next, with a default <code>interval</code> of 5s.
          </Subtitle1>
        }
        content={
          <Card
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            Using the <code>showArrows</code> prop, you can show the arrow icon
            buttons.
          </Subtitle1>
        }
        content={
      ...
      <DocCard
        ...
        subtitle={
          <Subtitle1>
            ...
            &nbsp; for "next" arrow and <code>prevIcon</code> for "prev" arrow.
          </Subtitle1>
        }
        content={
          <Card
      ...
      <ApiCard dark={dark} entity="Carousel" data={carouselApi(dark)} />
      <div className="mt-12"></div>
      <ApiCard dark={dark} entity="CarouselItem" data={carouselItemApi(dark)} />
    </Card>
  );
};
