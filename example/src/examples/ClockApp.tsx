...
class ClockApp extends React.Component<ClockAppProps, ClockAppState> {
  ...
  rotate(target: Element | null | any, val: number) {
  ...
  countDownTimer() {
    ...
    let minuteToNumber = Number(minute);
    ...
    this.setState({
      timerTime: {
        hour: hourToNumber.toString(),
        minute: minuteToNumber.toString(),
        second: secondToNumber.toString(),
      },
    });
  }
  ...
  onTimer(timerActive: boolean) {
    ...
    if (!timerActive) {
      ...
      this.setState({ timerTime: { hour: "01", minute: "00", second: "00" } });
    }
